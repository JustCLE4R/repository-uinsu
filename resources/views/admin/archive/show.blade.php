                ...
                <div class="bg-light rounded p-5 border-top border-success border-5" style="min-height: 70vh">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <span class="badge rounded-pill p-2 text-center fw-bold text-uppercase float-end
                            @if ($archive->status == 'pending')
                              bg-primary
                            @elseif ($archive->status == 'accepted')
                              bg-success
                            ...
                            ">
                              ...
                              @elseif ($archive->status == 'accepted')
                                Diterima <i class="bi bi-check2-all"></i>
                              @elseif ($archive->status == 'rejected')
                                Ditolak <i class="bi bi-x-lg"></i>
                              @endif
                            </span>
