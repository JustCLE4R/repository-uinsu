            ...
            <div class=" col-lg-10 bg-light p-5 pt-4 shadow-sm ">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-lg-9 col-sm-12">
                        <b>Jenis Item</b><br>
                        <span class="mb-1">Artikel</span></br>
                        <b>Subjek</b><br>
                        <span class="mb-1">200 Religion > 290 Other and comparative religions </span></br>
                        <b>Division</b><br>                                            
                        <span class="mb-1"class="mb-1">Fakultas Sains dan Teknologi, Prodi ILMU KOMPUTER</span></br>
                        <b>Editor</b><br>
                        <span class="mb-1">Mrs Tias Andini </span></br>
                        <b>Dibuat Pada</b><br>
                        <span class="mb-1">09 Dec 2023 02:49</span></br>
                    ...
                    <div class="col-lg-3 col-sm-12 text-center">                                            
                        ...
                        <a href="" class="btn btn-sm btn-success">Unduh <i class="fa-solid fa-download"></i></a>
