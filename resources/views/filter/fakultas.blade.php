...
@section('content')
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="">
                        ...
                        <div class="row">
                            ...
                            <div id="nama-fakultas" class="col-12">
                                
                            </div>
                        </div>
                        <div class="row" id="fakultas">
    ...
    <script>
        $(document).ready(function() {
            ...
            const fakultas = window.location.href.split('/').pop();
            const path = decodeURIComponent(window.location.pathname);
            const segments = path.split('/');
            const fakultass = segments.pop(); 

            $('#nama-fakultas').html(`<h5 class="my-2">Arsip Fakultas ${fakultass}</h5>`);
            $.ajax({
                url: `/api/archives?fakultas=${fakultas}`,
                method: 'GET',
                dataType: 'json',
