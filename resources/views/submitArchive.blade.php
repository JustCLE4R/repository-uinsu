  ...
  <div class="container mt-5">
    ...
    <form method="post" action="" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="abstract" name="abstract" value="{{ old('abstract') }}" required>
        @error('abstract')
          <div style="color: red; ">{{ $message }}</div>
        @enderror
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="editor" name="editor" value="{{ old('editor') }}" required>
        @error('editor')
          <div style="color: red; ">{{ $message }}</div>
        @enderror
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="isbn_issn" name="isbn_issn" value="{{ old('isbn_issn') }}" required>
        @error('isbn_issn')
          <div style="color: red; ">{{ $message }}</div>
        @enderror
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="official_url" name="official_url" value="{{ old('official_url') }}" required>
        @error('official_url')
          <div style="color: red; ">{{ $message }}</div>
        @enderror
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="volume" name="volume" value="{{ old('volume') }}" required>
        @error('volume')
          <div style="color: red; ">{{ $message }}</div>
        @enderror
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="journal_name" name="journal_name" value="{{ old('journal_name') }}" required>
        @error('journal_name')
          <div style="color: red; ">{{ $message }}</div>
        @enderror
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="nomor_klasifikasi" name="nomor_klasifikasi" value="{{ old('nomor_klasifikasi') }}" required>
